        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex-shrink-0">
            <button
              ...
              className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent hover:opacity-80 transition"
            >
              SB
            </button>
          </div>
          ...
          <div className="flex gap-4 items-center">
            ...
            <a
              ...
              className="text-muted-foreground hover:text-primary transition-colors w-6 h-6 flex items-center justify-center"
              title="GitHub"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
